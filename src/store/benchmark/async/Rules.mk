...
SRCS += $(addprefix $(d), benchmark.cc bench_client.cc sync_transaction_bench_client.cc)

OBJS-all-store-clients := $(OBJS-strong-client) $(OBJS-weak-client) $(OBJS-tapir-client)

LIB-bench-client := $(o)benchmark.o $(o)bench_client.o $(o)sync_transaction_bench_client.o
